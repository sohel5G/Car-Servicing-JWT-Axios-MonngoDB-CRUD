...
const CartPage = () => {
    ...
    return (
        <>
            <div>
                <h1 className="text-4xl text-center py-12">Total Cart Item 23</h1>
            </div>
                ...
                <div>
                    {
                        ...
                        //                 <Link to={'/products'}> <button className="py-2 px-4 bg-primary-myPrimaryColor text-white rounded-md"> Continue Shopping </button> </Link>
                        //         </div>
                        //     </div>
                        // </>
                    }
